...
class HQL_XL(nn.Module):
    ...
    def forward(self, wemb_n, l_n, wemb_hpu, l_hpu, l_hs,
        ...
        s_sc = self.scp(wemb_n, l_n, wemb_hpu, l_hpu, l_hs, show_p_sc=show_p_sc)   #参数不共享
        ...
        s_sa = self.sap(wemb_n, l_n, wemb_hpu, l_hpu, l_hs, pr_sc, show_p_sa=show_p_sa)  #参数不共享
        ...
        # wn   where_num
        s_wn = self.wnp(wemb_n, l_n, wemb_hpu, l_hpu, l_hs, show_p_wn=show_p_wn)   #参数不共享
        ...
        # wc   where_column
        s_wc = self.wcp(wemb_n, l_n, wemb_hpu, l_hpu, l_hs, show_p_wc=show_p_wc, penalty=True)  #参数不共享
        ...
        # wo   where_op
        s_wo = self.wop(wemb_n, l_n, wemb_hpu, l_hpu, l_hs, wn=pr_wn, wc=pr_wc, show_p_wo=show_p_wo)  #参数不共享
...
class SCP(nn.Module):
    ...
    ##web_n 每个question的bert_hidden  l_n 表示每个(WTP处理后)的Question_token的长度 wemb_hpu 表示每个header的bert_hidden l_hpu表示 每个header中的token的数量
